    ...
    <div class="mb-10 bg-white rounded-lg">
        ...
        <section
            ...
            <div
                x-show = "videoOpen"
                x-transition
                class="fixed top-0 left-0 z-30 flex items-center justify-center w-full h-screen bg-black bg-opacity-70"
                >
                <div
                    @click.outside = "videoOpen = false; url = ''"
                    class="w-11/12 mx-auto bg-white md:w-10/12 xl:w-8/12">
                    <iframe
